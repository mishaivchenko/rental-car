...
<div class="container">
    <dl>
        ...
        <dt><ctg:locale message="sum"/></dt>
        <dd><c:out value="${(requestScope.Damage.getSum())}"/></dd>
        <dt><ctg:locale message="crashDesc"/></dt>
        <dd><c:out value="${(requestScope.Damage.getDescription())}"/></dd>
    </dl>
    <form class="col-8" action="${pageContext.request.contextPath}/payDamage" method="get">
        <input type="hidden" value="${id}" name = "id"/>
        <button type="submit" class="btn btn-light"><ctg:locale message="payDamage"/></button>
    </form>
</div>
</body>
</html>